...
struct IndexerSurvey {
    pools: std::sync::Arc<crate::mixnet::pools::Pools>,
...
impl crate::mixnet::speed::SpeedPrioritized for IndexerSurvey {
    ...
    fn dispose(&self, spent: crate::mixnet::speed::Member) {
        ...
        self.pools.remember(
            spent.node().clone(),
            crate::mixnet::pools::exit_pool::ExitNodeHealthVerdict::EpochProven,
        );
    ...
    fn abandon(&self, dead: crate::mixnet::speed::Member) {
        self.pools.remember(
            dead.node().clone(),
            crate::mixnet::pools::exit_pool::ExitNodeHealthVerdict::Failed,
        );
        tokio::spawn(async move {
            dead.retire().await;
        });
...
fn lightd_chain_name(chain: &crate::config::ChainType) -> &'static str {
    match chain {
        ...
        crate::config::ChainType::SwarmMainnet(_) => crate::config::SWARM_MAINNET_NAME,
...
mod tests {
    ...
    fn a_healthy_answer_does_not_settle_the_survey() {
        let survey = IndexerSurvey {
            pools: crate::mixnet::pools::Pools::new(),
